...
namespace Assignment
{
    public class Assignment : MonoBehaviour
    {
        ...
        public void AS01_CountWords()
        {
            ...
            string[] keys = wordCounts.Keys.ToArray();
            int[] values = wordCounts.Values.ToArray();
        ...
        public void AS02_CountNumber()
        {
            ...
            int[] keys = numberCounts.Keys.ToArray();
            int[] values = numberCounts.Values.ToArray();
        ...
        public void AS07_RemoveDuplicatesFromLinkedList()
        {
            ...
            if (list.Count > 1)
            {
                ...
                while (current != null)
                {
                    // เก็บโหนดถัดไปก่อน เพราะ current อาจถูกลบ
        ...
        public void AS08_TopFrequentNumber()
        {
            ...
            for (int i = 0; i < numbers.Length; i++)
            {
                ...
                // อัปเดตเฉพาะเมื่อมากกว่า เพื่อเก็บตัวที่พบก่อนเมื่อเสมอกัน
                if (count > maxCount)
                {
                    topNumber = number;
                    maxCount = count;
